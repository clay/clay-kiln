...
describe(dirname, function () {
  describe(filename, function () {
    ...
    describe('toggleButton', function () {
      var fn = lib[this.title],
        button = dom.create('<div class="kiln-toolbar"><button class="publish">Publish</button></div>');
      ...
      it('toggles scheduled on', function () {
        fn('scheduled', true);
        expect(document.querySelector('.kiln-toolbar .publish').classList.contains('scheduled')).to.equal(true);
      });

      it('toggles scheduled off', function () {
        fn('scheduled', false);
        expect(document.querySelector('.kiln-toolbar .publish').classList.contains('scheduled')).to.equal(false);
      });

      it('toggles published on', function () {
        fn('published', true);
        expect(document.querySelector('.kiln-toolbar .publish').classList.contains('published')).to.equal(true);
      });

      it('toggles published off', function () {
        fn('published', false);
        expect(document.querySelector('.kiln-toolbar .publish').classList.contains('published')).to.equal(false);
      });
    });
