...
export default {
  [OPEN_FORM]: (state, { uri, path, inline, fields, schema, el, initialOffset, appendText, pos }) => {
    _.set(state, 'ui.currentForm', { uri, path, inline, fields, schema, el, initialOffset, appendText, pos });
    return state;
  },
  [CLOSE_FORM]: (state) => {
