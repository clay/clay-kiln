...
export default {
  [OPEN_FORM]: (state, { uri, path, inline, fields, schema, el, initialOffset, appendText }) => {
    _.set(state, 'ui.currentForm', { uri, path, inline, fields, schema, el, initialOffset, appendText });
    return state;
  },
  [CLOSE_FORM]: (state) => {
