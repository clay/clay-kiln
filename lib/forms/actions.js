 ...
 */
export function openForm(store, {
  uri, path, el, offset, appendText, pos, initialFocus
}) {
  ...
  store.commit(OPEN_FORM, {
    uri, path, inline: isInlineWYSIWYG, initialFocus, fields: _.cloneDeep(group.fields), schema: group.schema, initialOffset: offset, appendText, pos
  });
