...
define('form mutations', () => {
  it(`sets current form for ${OPEN_FORM}`, () => {
    expect(lib[OPEN_FORM]({}, { uri, path, inline, fields, schema, el, initialOffset, appendText })).to.eql({ ui: { currentForm: { uri, path, inline, fields, schema, el, initialOffset, appendText } } });
  });
