...
const MODEL_SAVE_TIMEOUT = 1000, // timeout for model.js pre-save hook
  MODEL_RENDER_TIMEOUT = 500; // timeout for model.js pre-render hook. should be smaller than pre-save
