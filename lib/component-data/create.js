  ...
  if (schema) {
    ...
    return props({
      ...
      if (store.state.componentKilnjs) {
        ...
        if (kilnFile) {
          newSchema = kilnFile({ ..._.cloneDeep(newSchema), schemaName: name });
        }
      }
