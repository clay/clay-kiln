...
import { UPDATE_COMPONENT, REVERT_COMPONENT, ADD_SCHEMA, RENDER_COMPONENT, REMOVE_COMPONENT, ADD_DEFAULT_DATA, CURRENT_SERVER_SAVE } from './mutationTypes';
...
export default {
  ...
  [CURRENT_SERVER_SAVE]: (state, isSaving) => {
    _.set(state, 'ui.currentServerSave', isSaving);
    return state;
  }
};
