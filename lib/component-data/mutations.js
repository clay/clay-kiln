...
import { UPDATE_COMPONENT, REVERT_COMPONENT, ADD_SCHEMA, RENDER_COMPONENT, REMOVE_COMPONENT, ADD_DEFAULT_DATA, CURRENTLY_SAVING, OPEN_ADD_COMPONENT, CLOSE_ADD_COMPONENT, CURRENTLY_RESTORING } from './mutationTypes';
...
export default {
  ...
  [CURRENTLY_RESTORING]: (state, isSaving) => {
    _.set(state, 'ui.currentlyRestoring', isSaving);
    return state;
  },
