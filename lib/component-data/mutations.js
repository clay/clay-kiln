...
import { UPDATE_COMPONENT, REVERT_COMPONENT, ADD_SCHEMA, UPDATE_SCHEMA_PROP, RENDER_COMPONENT, REMOVE_COMPONENT, ADD_DEFAULT_DATA, CURRENTLY_SAVING, OPEN_ADD_COMPONENT, CLOSE_ADD_COMPONENT, CURRENTLY_RESTORING } from './mutationTypes';
...
export default {
  ...
  [ADD_SCHEMA]: (state, {name, data}) => {
    _.set(state, `schemas['${name}']`, {...data, schema_name: name});
    return state;
  },
