...
import { getTemplate, getLocals, getData, getComponents } from '../core-data/components';
...
function getComponentNames(components) {
  ...
  return Object.keys(
    ...
    Object.keys(components).reduce((accumulator, currentValue)  => {
      accumulator[getComponentName(currentValue)] = true;
      return accumulator;
    }, {})
  );
}
