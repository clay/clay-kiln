...
import {
  refAttr, layoutAttr, editAttr, componentListProp, componentProp
} from '../utils/references';
import { getClickOffset } from '../utils/caret';
import { get } from '../core-data/groups';
import store from '../core-data/store';
import {
  fieldSelectors, getFieldEl, getComponentEl, isComponentInPage
...
function onFocus(uri, path, e) {
  ...
  if (isActive && fieldEl === e.delegateTarget) {
    ...
    store.dispatch('focus', {
      uri, path, el: fieldEl, offset: getClickOffset(e), pos
    });
  }
}
