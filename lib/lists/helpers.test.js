  ...
  describe('removeListItem', () => {
    ...
    test('remove an item from a list', () => {
      const items = [
          ...
          { text: 'gamma' }],
        tester = 'gamma',
        updatedItems = fn(items, tester, 'text');

      expect(lib.getItemIndex(updatedItems, tester, 'text')).toEqual(-1);
    });
