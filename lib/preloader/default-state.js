export default {
  ...
  page: {
    ...
    listData: {} // this page's representation in the list (data that's sent to the page list)
  },
  user: {},
  // ui state management
  ui: {
    ...
    currentServerSave: false // legacy server-saves need to block focusing other components
  },
