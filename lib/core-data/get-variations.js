...
/**
 * adds a componentVariation section/tab to a fields/section object
 * TODO: "fields/sections object" needs a properly named type
 * TODO: Explain what this does in more detail.
 *
 * @param {object.array} fields
 * @param {object.array} sections
 * @returns {object}
 **/
function addVariationSection({ fields, sections }) {
  const newSectionTitle = fields.length ? 'General' : 'Component Variation';

  fields.push('componentVariation');
  sections.push({
