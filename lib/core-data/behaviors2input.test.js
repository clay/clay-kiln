...
describe('behaviors2input', () => {
  ...
  describe('convertSchema', () => {
    ...
    it('converts (text) type=datetime-local to date input, and warns user', () => {
      ...
      expect(console.error).to.have.been.calledWith(`'${path}' (datetime-local) must be converted to two separate date and time fields! Editing this field in kiln will set the time to 12:00 AM on the date specified.`);
    });
