...
const mutations = _.assign({}, preloader, pageData, pageState, decorators, forms, components, panes, toolbar, deepLinking, validators, undo, lists, drawers, _.reduce(vanityMutations, (obj, name) => _.assign(obj, { [name]: vanityFunction }), {}));
