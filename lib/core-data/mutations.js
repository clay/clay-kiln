...
import page from '../page-state/mutations';
...
const mutations = _.assign({}, preloader, page, decorators, forms, components, pages, panes, toolbar, deepLinking, validators, undo);
