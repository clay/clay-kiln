...
import {
  refAttr, editAttr, layoutAttr, hiddenAttr, pageAreaClass
} from './references';
import { getComponentNode } from './head-components';
...
export function isComponentInHead(uri) {
  return !!getComponentNode(uri);
}
