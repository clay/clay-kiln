...
describe('promises', () => {
  ...
  describe('reduce', () => {
    ...
    test('reduces in series for promises in initial list', () => {
      let promise,
        d1 = lib.defer(),
        d2 = lib.defer(),
    ...
    test('reduces in series for promises in returned list', () => {
      let promise,
        d1 = lib.defer(),
        d2 = lib.defer(),
        data = ['a', 'b'],
  ...
  describe('transform', () => {
    ...
    test('transforms in parallel for promises in initial list', () => {
      let promise,
        d1 = lib.defer(),
        d2 = lib.defer(),
        data = [d1.promise, d2.promise],
    ...
    test('transforms in parallel for promises in returned list', () => {
      let promise,
        d1 = lib.defer(),
        d2 = lib.defer(),
        data = ['a', 'b'],
  ...
  describe('attempt', () => {
    ...
    test('catches thrown error', (done) => {
      fn(() => {
        throw new Error('hey');
      }).then(() => {
