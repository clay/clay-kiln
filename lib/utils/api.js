...
import { isComponent, isDefaultComponent, getComponentName, getComponentInstance, getComponentVersion, replaceVersion } from 'clayutils';
...
const api = {
  ...
  references: Object.assign({}, references, { isComponent, isDefaultComponent, getComponentName, getComponentInstance, getComponentVersion, replaceVersion }),
  urls,
