...
import { isComponent, isDefaultComponent, getComponentInstance, getComponentVersion, replaceVersion } from 'clayutils';
...
const api = {
  ...
  references: Object.assign({}, references, { isComponent, isDefaultComponent, getComponentInstance, getComponentVersion, replaceVersion }),
  urls,
